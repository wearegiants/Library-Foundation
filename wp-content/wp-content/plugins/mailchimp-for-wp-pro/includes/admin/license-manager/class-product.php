...
if( ! class_exists( 'DVK_Product', false ) ) {
	...
	class DVK_Product {
		...
		public function __construct( $api_url, $item_name, $slug, $version, $item_url = '', $license_page_url = '#', $text_domain = 'mailchimp-for-wp', $author = 'Danny van Kooten', $option_prefix = 'mc4wp_' ) {
