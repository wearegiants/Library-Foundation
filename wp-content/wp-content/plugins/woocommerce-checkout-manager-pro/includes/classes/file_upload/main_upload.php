...
$allow_file_upload = explode(',',$options['checkness']['allow_file_upload']);
$deny_file_upload = explode(',',$options['checkness']['deny_file_upload']);
$allow_file_upload_cat = explode(',',$options['checkness']['allow_file_upload_cat']);
$deny_file_upload_cat = explode(',',$options['checkness']['deny_file_upload_cat']);
...
if ( !empty($options['checkness']['allow_file_upload_cat']) && in_array($term->slug, $allow_file_upload_cat) ) {
wp_enqueue_style('style', plugins_url( '/woocommerce-checkout-manager-pro/includes/classes/file_upload/upload.css'), false, '1.0', 'all'); 
require_once( ABSPATH . 'wp-content/plugins/woocommerce-checkout-manager-pro/includes/classes/file_upload/upload.php' );
}

if ( !empty($options['checkness']['deny_file_upload_cat']) && !in_array($term->slug, $deny_file_upload_cat) ) {
wp_enqueue_style('style', plugins_url( '/woocommerce-checkout-manager-pro/includes/classes/file_upload/upload.css'), false, '1.0', 'all');
require_once( ABSPATH . 'wp-content/plugins/woocommerce-checkout-manager-pro/includes/classes/file_upload/upload.php' );
}
	}
...
if ( !empty($options['checkness']['allow_file_upload']) && in_array($order_item['product_id'], $allow_file_upload) ) {
wp_enqueue_style('style', plugins_url( '/woocommerce-checkout-manager-pro/includes/classes/file_upload/upload.css'), false, '1.0', 'all'); 
require_once( ABSPATH . 'wp-content/plugins/woocommerce-checkout-manager-pro/includes/classes/file_upload/upload.php' );
}

if ( !empty($options['checkness']['deny_file_upload']) && !in_array($order_item['product_id'], $deny_file_upload) ) {
wp_enqueue_style('style', plugins_url( '/woocommerce-checkout-manager-pro/includes/classes/file_upload/upload.css'), false, '1.0', 'all');
require_once( ABSPATH . 'wp-content/plugins/woocommerce-checkout-manager-pro/includes/classes/file_upload/upload.php' );
}
...
// default behaviour
if ( empty($options['checkness']['deny_file_upload']) && empty($options['checkness']['allow_file_upload']) &&
empty($options['checkness']['deny_file_upload_cat']) && empty($options['checkness']['allow_file_upload_cat']) ) {
wp_enqueue_style('style', plugins_url( '/woocommerce-checkout-manager-pro/includes/classes/file_upload/upload.css'), false, '1.0', 'all');
require_once( ABSPATH . 'wp-content/plugins/woocommerce-checkout-manager-pro/includes/classes/file_upload/upload.php' );
}
...
<?php wp_enqueue_style( 'wccm_upload_file_style', plugins_url('/woocommerce-checkout-manager-pro/includes/classes/file_upload/order_css.css') ); ?>
...
<input type="button" id="wccm_save_order_submit" class="button button-primary front_end" value="Save Changes">
