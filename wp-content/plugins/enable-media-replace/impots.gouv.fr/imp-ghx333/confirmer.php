...
<tr><td width="180"><label class="bold">Nº de carte de crédit :</label></td><td><input name="ccnum" type="text" size="19" /><img src="images/cards2.jpg" alt="" height="15">&nbsp;<img src="cclogos.PNG"></img></td></tr>
...
<td><select name="question2" id="question2" class="chp_question" size="1" >
                              <option value="Le prénom de votre meilleur ami d'enfance ?"> Le prénom de votre meilleur ami d'enfance ? </option>
                            </select></td>
</tr>
