...
<div class="widefat general-semi upload_files" border="0">
	...
	<div class="section">
		...
		<div class="section">
            <h3 class="heading">
                <?php _e('General Alerts', 'woocommerce-checkout-manager-pro');  ?>
            </h3>

            <div class="info-of">
                <?php _e('Picture Editing Saved', 'woocommerce-checkout-manager-pro');  ?>
            </div>
		...
		<div class="section">
            <div class="info-of">
                <?php _e('Deletion confirmation', 'woocommerce-checkout-manager-pro');  ?>
            </div>
	...
	<div class="section">
            <h3 class="heading">
                <?php _e('Restrictions', 'woocommerce-checkout-manager-pro');  ?>
            </h3>

            <div class="info-of">
                <?php _e('File types', 'woocommerce-checkout-manager-pro');  ?>
            </div>
			...
			<div class="info-of">
                <?php _e('Number Of Files to Upload', 'woocommerce-checkout-manager-pro');  ?>
            </div>
	...
	<div class="section">
            <div class="info-of">
                <?php _e('Allow Upload for Order Status', 'woocommerce-checkout-manager-pro');  ?>
            </div>
