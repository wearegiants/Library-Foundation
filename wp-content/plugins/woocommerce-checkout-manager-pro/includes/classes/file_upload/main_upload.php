...
<?php wp_enqueue_style( 'wccm_upload_file_style', plugins_url('/woocommerce-checkout-manager-pro/includes/classes/file_upload/file_editing_table.css') ); ?>
...
echo ''.__('Deleted Successfully.','woocommerce-checkout-manager-pro').'';
}
die();
}