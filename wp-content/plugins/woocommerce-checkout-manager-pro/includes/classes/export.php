...
<h1 class="heading-blue"><?php _e( 'Field Data Export', 'woocommerce-checkout-manager-pro'); ?></h1>
</div>
...
<!-- ADDITIONAL SECTION --> 
		<p class="about-description heading"><?php _e( 'Additional Fields Section', 'woocommerce-checkout-manager-pro'); ?>
		</p>
		<hr />
        <div class="welcome-panel-content">
                <p class="about-description inner"><?php _e( 'Export All Orders with abbreviation name : ', 'woocommerce-checkout-manager-pro'); ?>
                ...
                <div class="welcome-panel-column-container">
                	<div class="welcome-panel-column">
                        <ul>
                			<a class="button button-primary button-hero single-download additional" href="#"><?php _e( 'Download', 'woocommerce-checkout-manager-pro'); ?></a>
                		</ul>  
                    </div>
                </div>
			...
			<div class="sheet ">
				...
				<p style="clear:both;" class="about-description inner"><?php _e( 'Export All Orders', 'woocommerce-checkout-manager-pro'); ?>
				</p>
                
                <div class="welcome-panel-column-container">
                	<div class="welcome-panel-column">
                        <ul>
                			<a class="button button-primary button-hero all-download additional" href="#"><?php _e( 'Download', 'woocommerce-checkout-manager-pro'); ?></a>	
                		</ul>  
                    </div>
                </div>
			...
			<p style="clear:both;" class="about-description inner"><?php _e( 'Export Settings', 'woocommerce-checkout-manager-pro'); ?>
				</p>
                
                <div class="welcome-panel-column-container">
                	<div class="welcome-panel-column">
                        <ul>
                			<a class="button button-primary button-hero setting-download additional" href="#"><?php _e( 'Download', 'woocommerce-checkout-manager-pro'); ?></a>
                		</ul>  
                    </div>
                </div>
...
<!-- BILLING SECTION -->
		<p class="about-description heading"><?php _e( 'Billing Fields Section', 'woocommerce-checkout-manager-pro'); ?>
		</p>
		<hr />
        <div class="welcome-panel-content">
                <p class="about-description inner"><?php _e( 'Export All Orders with abbreviation name : ', 'woocommerce-checkout-manager-pro'); ?>
                ...
                <div class="welcome-panel-column-container">
                	<div class="welcome-panel-column">
                        <ul>
                			<a class="button button-primary button-hero single-download billing" href="#"><?php _e( 'Download', 'woocommerce-checkout-manager-pro'); ?></a>
                		</ul>  
                    </div>
                </div>
			...
			<div class="sheet ">
                ...
                <div class="welcome-panel-column-container">
                	<div class="welcome-panel-column">
                        <ul>
                			<a class="button button-primary button-hero all-download billing" href="#"><?php _e( 'Download', 'woocommerce-checkout-manager-pro'); ?></a>	
                		</ul>  
                    </div>
                </div>
			...
			<p style="clear:both;" class="about-description inner"><?php _e( 'Export Settings', 'woocommerce-checkout-manager-pro'); ?>
                ...
                <div class="welcome-panel-column-container">
                	<div class="welcome-panel-column">
                        <ul>
                			<a class="button button-primary button-hero setting-download billing" href="#"><?php _e( 'Download', 'woocommerce-checkout-manager-pro'); ?></a>
                		</ul>  
                    </div>
                </div>
...
<!-- SHIPPING SECTION -->
		<p class="about-description heading"><?php _e( 'Shipping Fields Section', 'woocommerce-checkout-manager-pro'); ?>
		</p>
		<hr />
        <div class="welcome-panel-content">
                <p class="about-description inner"><?php _e( 'Export All Orders with abbreviation name : ', 'woocommerce-checkout-manager-pro'); ?>
                ...
                <div class="welcome-panel-column-container">
                	<div class="welcome-panel-column">
                        <ul>
                			<a class="button button-primary button-hero single-download shipping" href="#"><?php _e( 'Download', 'woocommerce-checkout-manager-pro'); ?></a>
                		</ul>  
                    </div>
                </div>
			...
			<div class="sheet  ">
                ...
                <div class="welcome-panel-column-container">
                	<div class="welcome-panel-column">
                        <ul>
                			<a class="button button-primary button-hero all-download shipping" href="#"><?php _e( 'Download', 'woocommerce-checkout-manager-pro'); ?></a>	
                		</ul>  
                    </div>
                </div>
			...
			<p style="clear:both;" class="about-description inner"><?php _e( 'Export Settings', 'woocommerce-checkout-manager-pro'); ?>
                ...
                <div class="welcome-panel-column-container">
                	<div class="welcome-panel-column">
                        <ul>
                			<a class="button button-primary button-hero setting-download shipping" href="#"><?php _e( 'Download', 'woocommerce-checkout-manager-pro'); ?></a>
                		</ul>  
                    </div>
                </div>
