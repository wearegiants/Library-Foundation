...
function jquery_wccs_emit() {
	...
	$suffix = defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ? '' : '.min';
		...
		if( is_account_page() ) {
			...
			wp_enqueue_style('wooccm-button-style', plugins_url( '/woocommerce-checkout-manager-pro/includes/classes/file_upload/button_style.css'), false, '1.0', 'all');
		}
        ...
        if ( is_checkout() ) {
			...
			wp_enqueue_script( 'iris', plugins_url('woocommerce-checkout-manager-pro/includes/pickers/iris/dist/iris.js'), array( 'jquery-ui-draggable', 'jquery-ui-slider', 'jquery-touch-punch' ), false, 1 );
			...
			wp_enqueue_style( 'magnific-popup', plugins_url('woocommerce-checkout-manager-pro/includes/pickers/magnificpopup/dist/magnific-popup.css')  );
			wp_enqueue_script( 'magnific-popup', plugins_url('woocommerce-checkout-manager-pro/includes/pickers/magnificpopup/dist/jquery.magnific-popup.js') );
			
			wp_enqueue_script( 'caman', plugins_url('woocommerce-checkout-manager-pro/includes/pickers/caman/dist/caman.js') );
			wp_enqueue_style( 'caman', plugins_url('woocommerce-checkout-manager-pro/includes/pickers/caman/dist/caman.css') );
			
			wp_enqueue_script( 'jcrop-color', plugins_url('woocommerce-checkout-manager-pro/includes/pickers/jcrop/js/jquery.color.js') );
			wp_enqueue_script( 'jcrop', plugins_url('woocommerce-checkout-manager-pro/includes/pickers/jcrop/js/jquery.Jcrop.js') );
