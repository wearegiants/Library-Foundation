...
class WC_Min_Max_Quantities_Admin {
    ...
    function variation_options( $loop, $variation_data, $variation ) {
    	...
    	?>
	    	...
	    	<label><input type="checkbox" class="checkbox min_max_rules" name="min_max_rules[<?php echo $loop; ?>]" <?php if ( isset( $variation_data['min_max_rules'][0] ) ) checked( $variation_data['min_max_rules'][0], 'yes' ); ?> /> <?php _e( 'Min/Max Rules', 'woocommerce-min-max-quantities' ); ?> <a class="tips" data-tip="<?php _e( 'Enable this option to override min/max settings at variation level', 'woocommerce-min-max-quantities' ); ?>" href="#">[?]</a></label>
    ...
    function variation_panel( $loop, $variation_data, $variation ) {
	    ...
	    <?php } else { ?>
		    <tr class="min_max_rules_options" <?php echo $visible; ?>>
		    	<td>
					<label><?php _e( 'Minimum quantity', 'woocommerce-min-max-quantities' ); ?></label>
				...
				<td>
					<label><?php _e( 'Maximum quantity', 'woocommerce-min-max-quantities' ); ?> <input type="text" size="5" name="variation_maximum_allowed_quantity[<?php echo $loop; ?>]" value="<?php if ( isset( $variation_data['maximum_allowed_quantity'][0] ) ) echo $variation_data['maximum_allowed_quantity'][0]; ?>" />
				</td>
		    </tr>
		    <tr class="min_max_rules_options" <?php echo $visible; ?>>
		    	<td>
				...
				<td>
					...
					<label><input type="checkbox" class="checkbox" name="variation_minmax_do_not_count[<?php echo $loop; ?>]" <?php if ( isset( $variation_data['minmax_do_not_count'][0] ) ) checked( $variation_data['minmax_do_not_count'][0], 'yes' ) ?> /> <?php _e( 'Order rules: Do not count', 'woocommerce-min-max-quantities' ); ?> <a class="tips" data-tip="<?php _e( 'Don\'t count this product against your minimum order quantity/value rules.', 'woocommerce-min-max-quantities' ); ?>" href="#">[?]</a></label>

					<label><input type="checkbox" class="checkbox" name="variation_minmax_cart_exclude[<?php echo $loop; ?>]" <?php if ( isset( $variation_data['minmax_cart_exclude'][0] ) ) checked( $variation_data['minmax_cart_exclude'][0], 'yes' ) ?> /> <?php _e( 'Order rules: Exclude', 'woocommerce-min-max-quantities' ); ?> <a class="tips" data-tip="<?php _e( 'Exclude this product from minimum order quantity/value rules. If this is the only item in the cart, rules will not apply.', 'woocommerce-min-max-quantities' ); ?>" href="#">[?]</a></label>

					<label><input type="checkbox" class="checkbox" name="variation_minmax_category_group_of_exclude[<?php echo $loop; ?>]" <?php if ( isset( $variation_data['minmax_category_group_of_exclude'][0] ) ) checked( $variation_data['minmax_category_group_of_exclude'][0], 'yes' ) ?> /> <?php _e( 'Category group-of rules: Exclude', 'woocommerce-min-max-quantities' ); ?> <a class="tips" data-tip="<?php _e( 'Exclude this product from category group-of-quantity rules. This product will not be counted towards category groups.', 'woocommerce-min-max-quantities' ); ?>" href="#">[?]</a></label>
