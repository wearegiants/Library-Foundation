<?php Themewrangler::setup_page();get_header(/***Template Name: Archive Categories */); ?>
...
<?php endif; ?>
  <div class="row">
    <div class="desktop-12 tablet-6 mobile-3">
      ...
      <h1 class="page-header-title"><?php the_title(); ?><?php echo $catName; ?></h1>
    </div>
  </div>
</div>
...
<div id="archive--wrapper">
  <div id="archive--newest">
    <div class="row">
      <div class="desktop-12 tablet-6 mobile-3">
        <?php include locate_template('/templates/media/categories.php' ); ?>
      </div>
    </div>
  </div>
</div>
